...
We'll employ this [Terraform module](../../../../terraform/gcp/registry/README.md) to create a registry.

## Create a new workload cluster

Next, we're going to employ another [Terraform module](../../../../terraform/gcp/cluster/README.md) to create a cluster.
